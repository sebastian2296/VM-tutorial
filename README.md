...
![alt text](sebastian2296/https://github.com/sebastian2296/VM-tutorial/blob/main/img/.png)
...
* Damos click sobre el ícono verde en la parte inferior izquierda (subrayado en rojo) y creamos la conexión con la opicón **Connect to Host**.
